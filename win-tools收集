...
DropIt——自动整理文档
网址：dropitproject.com/
一款可以自动整理文档的软件，平时我喜欢在把各种文件保存到桌面，但是整理的时候真的超级麻烦，用了这个软件之后，整理文件就超级轻松了。
只需要将所有的文件拖拽到图标的位置，就可以自动为这些文件分类并建立对应的文件夹。
迅捷PDF转换器
网址：xunjiepdf.com/converter
